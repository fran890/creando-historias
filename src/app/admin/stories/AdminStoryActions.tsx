    ...
    <div className="flex items-center space-x-3">
      ...
      {currentStatus === "PENDING_REVIEW" && (
        <button
          ...
          className="inline-flex items-center space-x-1 px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded-xl transition disabled:opacity-50 shadow-xs"
        >
      ...
      {currentStatus === "DRAFT" && (
        <span className="inline-flex items-center space-x-1 px-3 py-1.5 bg-gray-800 text-gray-400 border border-gray-700 text-[11px] font-medium rounded-xl">
      ...
      {currentStatus === "PUBLISHED" && (
        <button
          ...
          className="inline-flex items-center space-x-1 px-3 py-1.5 bg-amber-600/80 hover:bg-amber-700 text-white text-xs font-semibold rounded-xl transition disabled:opacity-50"
        >
      ...
      {currentStatus !== "REJECTED" && currentStatus === "PENDING_REVIEW" && (
        <button
          ...
          className="inline-flex items-center space-x-1 px-3 py-1.5 bg-red-600/80 hover:bg-red-700 text-white text-xs font-semibold rounded-xl transition disabled:opacity-50"
        >
