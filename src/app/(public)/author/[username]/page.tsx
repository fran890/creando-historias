...
import { BookOpen, Eye, Clock, Calendar, ArrowLeft, Folder } from "lucide-react";
  ...
  return (
    <div className="relative pb-24 bg-gray-50 dark:bg-gray-950 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
        ...
        {/* Hero Author Profile Banner Header */}
            ...
            <div className="space-y-3 flex-grow">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 pt-2 text-xs font-semibold">
                <span className="inline-flex items-center space-x-1.5 bg-white/10 px-3.5 py-1.5 rounded-xl border border-white/20">
                  ...
                  <span>{author.articles.length} Historias Publicadas</span>
                </span>
                {currentUser && (
                  <span className="inline-flex items-center space-x-1.5 bg-white/10 px-3.5 py-1.5 rounded-xl border border-white/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          {/* Left Column: Author Stories Feed (8 cols) */}
          <main className="lg:col-span-8 space-y-8">
            <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-4">
              <h2 className="font-serif text-2xl font-bold text-gray-900 dark:text-white">
                Todas las publicaciones de {author.name}
              </h2>
              <span className="text-xs text-gray-500">{author.articles.length} resultados</span>
            </div>
            ...
            {author.articles.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {author.articles.map((art, index) => {
                  const shouldShowAd = (index + 1) % 2 === 0 && index < author.articles.length - 1;
                  return (
          ...
          {/* Right Column: Sticky Sidebar Ads (4 cols) */}
