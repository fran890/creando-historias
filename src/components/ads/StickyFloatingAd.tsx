...
export default function StickyFloatingAd({ slotId, className = "" }: StickyFloatingAdProps) {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-800 shadow-2xl p-2 flex justify-center items-center ${className}`}>
      <button
